...
regime_impact = "⚠️ Headwind for commodities" if is_bullish else "✅ Tailwind for commodities"
...
|------------|--------------------------|---------------------------|
| **Bearish** (below MA200) | ✅ Tailwind — full macro score | ⚠️ Headwind — reduced score |
| **Bullish** (above MA200) | ⚠️ Headwind — reduced score | ✅ Tailwind — full macro score |
