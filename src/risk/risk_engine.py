...
for every qualifying signal.  No approximations â€” all values derived from
...
def compute_portfolio_cash_requirement(macro_score: float) -> float:
    ...
    Macro score < 48 â†’ 30% cash.  Otherwise â†’ 15%.
    """
...
def compute_aggregate_macro_score(signals: list[SignalResult]) -> float:
    ...
    # Normalise to 0â€“100 scale (macro max is 20)
