...
Scores every market from 0ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“100 across five components.
...
class ComponentScores:
    commercial_cot: float = 0.0       # 0ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“35
    seasonality: float = 0.0          # 0ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“25
    macro_regime: float = 0.0         # 0ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“20
    trend_alignment: float = 0.0      # 0ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“10
    momentum: float = 0.0             # 0ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“10
...
def score_commercial_cot(cot_index: float | None, direction: Direction) -> float:
    ...
    COT index 0ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“100: >70 = heavy commercial buying (bullish for price).
    For longs: high COT index ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ high score.
    For shorts: low COT index ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ high score.
    """
    ...
    if direction == Direction.LONG:
        # COT index 70ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“100 maps to full score; 0ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“30 maps to near zero
...
def score_seasonality(symbol: str, direction: Direction, month: int) -> float:
    ...
    # We map [0, 1.5] ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ [0, 25] for the favoured direction
    if direction == Direction.LONG:
...
def score_macro_regime_equity(
    ...
    US10Y: below MA ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ bullish equity; above MA ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ bearish equity.
    """
...
def score_macro_regime_commodity(
    ...
    DXY regime: bearish DXY ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ bullish commodities.
    ...
    # Real yield component ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Gold/Silver only (up to 6 pts)
...
def determine_direction(
    ...
    if cot_index >= 60:
        ...
        # Ambiguous COT ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â use seasonality as tiebreaker
        if season_bias > 0.3:
            cot_dir = Direction.LONG
    ...
    if asset_class == AssetClass.EQUITY:
        if cot_dir == Direction.LONG and regime.us10y_above_ma:
            # Unfavourable but not blocked ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â weaken signal via scoring
            pass
...
async def score_market(
    ...
    # VIX hard override ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â no new positions at all
    if regime.vix_override:
        logger.info("VIX override ({:.1f}) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â skipping {}", regime.vix, symbol)
        return None
    ...
    if not result.passes_threshold:
        logger.debug(
            "{} score {:.1f} below threshold ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â skipping",
            symbol, result.score,
        )
        return None
